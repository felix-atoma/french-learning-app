...
const Enrollment = () => {
  ...
  return (
    <section id="enrollment" ref={sectionRef} className="py-20 bg-gradient-to-br from-gray-50 to-white">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          >
            <span>🎓</span>
            <span>Start Your French Journey</span>
          </motion.div>
          <h2 className="text-4xl md:text-5xl font-bold text-[#1e3a8a] mb-6">
            Enroll in Our French Programs
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Choose your preferred enrollment method and start learning French with Ghana's leading language institution.
          </p>
        </motion.div>
        ...
        >
          <h3 className="text-2xl font-bold text-[#1e3a8a] mb-8 text-center">Choose Your Program</h3>
