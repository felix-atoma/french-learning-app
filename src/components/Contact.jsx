...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    alert('Thank you for your interest! We will contact you within 24 hours to discuss how our French Learning App can benefit your school.')
  }
    ...
    <section id="contact" ref={sectionRef} className="py-20 bg-white relative overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          >
            <h3 className="text-3xl font-bold text-educational-navy mb-8">
            ...
            <div className="space-y-6 mb-8">
              {contactMethods.map((method, index) => (
                <motion.a
                  key={index}
                  href={method.action}
                  className="flex items-start space-x-4 p-6 bg-educational-lightBlue rounded-2xl hover:bg-educational-blue hover:text-white transition-all duration-300 group cursor-pointer"
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-educational-navy group-hover:text-white transition-colors">
                      {method.details}
                    </p>
                    <p className="text-sm text-gray-600 group-hover:text-educational-lightBlue transition-colors mt-1">
                      {method.description}
                    </p>
                  </div>
                </motion.a>
            ...
            {/* Quick Facts */}
            <motion.div
              className="bg-educational-navy text-white rounded-2xl p-6"
              initial={{ opacity: 0, y: 30 }}
              animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 30 }}
              transition={{ duration: 0.6, delay: 0.7 }}
            >
              <h4 className="text-xl font-bold mb-4 text-educational-gold">
          ...
          <motion.div
            ...
            animate={isInView ? { opacity: 1, x: 0 } : { opacity: 0, x: 50 }}
            transition={{ duration: 0.6, delay: 0.3 }}
            className="bg-educational-lightBlue rounded-3xl p-8 shadow-xl border border-educational-blue/20"
          >
            <h3 className="text-3xl font-bold text-educational-navy mb-6">
              Request Free Trial
            </h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-educational-navy font-semibold mb-2">
                    Your Name *
                  </label>
                  <input
                    type="text"
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:outline-none focus:ring-2 focus:ring-educational-blue focus:border-transparent transition-all duration-300"
                    required
              ...
              <motion.button
                type="submit"
                className="w-full bg-educational-blue text-white py-4 rounded-xl font-bold text-lg hover:bg-educational-navy transition-colors shadow-lg"
        ...
        {/* Final CTA */}
        <motion.div
          className="text-center mt-16 bg-gradient-to-r from-educational-blue to-educational-navy rounded-3xl p-8 md:p-12 text-white"
        ...
        >
          ...
          <p className="text-xl text-educational-lightBlue mb-8 max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-6">
            <motion.a
              href="#trial"
              className="bg-educational-gold text-educational-navy px-8 py-4 rounded-xl font-bold text-lg hover:bg-yellow-400 transition-colors shadow-lg"
            ...
            <motion.a
              ...
              className="border-2 border-white text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-white hover:text-educational-blue transition-colors"
              whileHover={{ scale: 1.05, y: -2 }}
              whileTap={{ scale: 0.98 }}
            >
